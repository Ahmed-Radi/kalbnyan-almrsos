...
const expenseOne = store.dispatch(addExpense({ description: 'Hi I am Ahmed Radi',amount: 200000, createdAt: 1000 }));
const expenseTwo = store.dispatch(addExpense({ description: 'Hi I am Ali Radi',amount: 1, createdAt: -1000 }));
